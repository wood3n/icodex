...
![image-20200730105454730](../../../../../File/note/interview/JS/images/image-20200730105454730.png)
...
- 当且仅当左侧为`null`或`undefined`的时候，才返回左侧的值，其余情况都是返回右侧的值

```javascript
console.log(null ?? ''); // ""
```

这个操作符目前 V8 引擎已经支持了，其为 JS 判断值是否为`undefined`提供了极大的便利呀！
